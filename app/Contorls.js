...
var Contorl = function(){
    ...
    function init(){
        ...
        gui.open();
        var cdsac = new THREE.BoxGeometry(0.8,0.6,0.1 );
		var cdaca = new THREE.MeshBasicMaterial( {wireframe:true} );
        var cs = new THREE.Mesh(cdsac,cdaca);
        planet.addMesh(cs,'test',117.5,22.35,0.2);
        cs.material = new THREE.MeshBasicMaterial( {wireframe:true,color:0xffffff} );
         mapLoad();
    }
    function mapLoad(){
