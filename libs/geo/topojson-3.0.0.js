...
//
// For a closed ring ABCA, the first point Aa€?s adjacent points are the second
...
var presimplify = function(topology, weight) {
  ...
  var arcs = topology.arcs.map(function(arc) {
    ...
    while (triangle = heap.pop()) {
      ...
      // point to be eliminated, use the lattera€?s weight instead. This ensures
...
function halfArea(ring, closed) {
  ...
  for (; i < n; ++i) {
    ...
    // previous point, current point.  Uses a formula derived from Cagnolia€?s
